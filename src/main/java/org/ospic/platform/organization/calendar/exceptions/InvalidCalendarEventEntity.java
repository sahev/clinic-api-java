 ...
 * under the License.
 */
public class InvalidCalendarEventEntity  extends AbstractPlatformException {
    protected InvalidCalendarEventEntity(String globalisationMessageCode, String defaultUserMessage) {
