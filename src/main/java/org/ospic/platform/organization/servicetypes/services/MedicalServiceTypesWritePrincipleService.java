...
@Component
@Service
public interface MedicalServiceTypesWritePrincipleService {
    ResponseEntity<?> createServiceTypes(MedicalServiceTypes payload);
    ResponseEntity<?> updateServiceType(Long id, MedicalServiceTypes payload);
    ResponseEntity<?> deleteServiceType(Long id);
}
