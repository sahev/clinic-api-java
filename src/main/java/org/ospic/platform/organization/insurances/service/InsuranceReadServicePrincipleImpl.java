 ...
 */
@Repository
public class InsuranceReadServicePrincipleImpl  implements InsuranceReadServicePrinciple{
    private final InsuranceRepository insuranceRepository;

    @Autowired
    public InsuranceReadServicePrincipleImpl(final InsuranceRepository insuranceRepository){
        this.insuranceRepository = insuranceRepository;
    }
    @Override
    public Collection<Insurance> getListOfInsuranceCompanies() {
