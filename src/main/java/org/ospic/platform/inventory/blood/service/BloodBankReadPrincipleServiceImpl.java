 ...
 */
@Repository
public class BloodBankReadPrincipleServiceImpl implements BloodBankReadPrincipleService{
    @Autowired
    BloodBankRepository bloodBankRepository;

    @Autowired
    public BloodBankReadPrincipleServiceImpl(BloodBankRepository bloodBankRepository){
