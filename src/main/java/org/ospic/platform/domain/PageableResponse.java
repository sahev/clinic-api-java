...
/**
 * This file was created by eli on 14/12/2020 for org.ospic.platform.domain
 * --
 * --
...
public class PageableResponse  {
    ...
    public PageableResponse(Map<String, Object> response) {
    ...
    public Map<String, Object> instance(Page page, Class<?> object){
        ...
        return new PageableResponse(response).getResponse();
    }
}
