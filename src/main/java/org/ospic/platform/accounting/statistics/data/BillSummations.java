...
@NoArgsConstructor
@AllArgsConstructor
public class BillSummations {
    private Long totalNumberOfBills;
    private Long totalNumberOfBillsToday;
    private BigDecimal totalBillsAmountToday;
    private BigDecimal totalBillsPaidAmountToday;
    ...
    public static BillSummations fromResultSet(ResultSet rs) throws SQLException {
        ...
        final BigDecimal totalBillsPaidAmountToday = rs.getBigDecimal("totalBillsPaidAmountToday");
        final BigDecimal totalBillsAmount = rs.getBigDecimal("totalBillsAmount");
        final BigDecimal totalBillsPaidAmount = rs.getBigDecimal("totalBillsPaidAmount");
        return new BillSummations(totalNumberOfBills, totalNumberOfBillsToday,totalBillsAmountToday,totalBillsPaidAmountToday,totalBillsAmount,totalBillsPaidAmount);
