...
@Component
@Service
public interface AccountingStatisticsReadService {
    ResponseEntity<?> readBillsPerDayAccountingStatistics();
    ResponseEntity<?> readBillSummationAccountingStatistics();
    ResponseEntity<?> readTransactionsPerDayAccountingStatistics();
